(() => {
    ...
    function windowLoad() {
        ...
        let userTheme;
        if (window.matchMedia) userTheme = window.matchMedia("(prefers-color-sheme: dark)").matches ? "dark" : "light";
        window.matchMedia("(prefers-color-sheme: dark)").addEventListener("change", (e => {
